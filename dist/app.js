  ...
  $.ajax({
    ...
    success: function success(datares) {
      ...
      for (var i = 0; i < cds.length; i++) {
        var cd = cds[i]; //var author = cd['author'];
        //console.log(author);
...
__webpack_require__(/*! /Users/michele/Documents/Boolean/repo/mamp-htdocs/php-ajax-dischi/src/app.js */"./src/app.js");
module.exports = __webpack_require__(/*! /Users/michele/Documents/Boolean/repo/mamp-htdocs/php-ajax-dischi/src/app.scss */"./src/app.scss");
